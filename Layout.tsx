...
const SIDEBAR_ITEMS = [
  ...
  { id: 'tools', label: '测评工具管理', icon: Wrench }, // Added Tool Management
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange, onCreateTask }) => {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      >
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/50">
          <div className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white cursor-pointer rounded-lg hover:bg-slate-800 transition">
            <Settings size={18} />
